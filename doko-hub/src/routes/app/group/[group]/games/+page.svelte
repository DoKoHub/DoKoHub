...
<!-- Neues Spiel starten mit Dialog -->
<Dialog
...
>
  ...
  <DialogContent>
    <p id="ng-desc" class="hint">
      Wählen Sie ob Sie mit oder ohne Pflichtsolos spielen möchten. Anschließend können Sie die vorgegebene Sitzreihenfolge anpassen.
    </p>
