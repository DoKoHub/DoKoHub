...
export const ruleset = pgEnum("ruleset", ["STANDARD", "HAUSREGEL_KURZSPIEL"]);

export const memberstatus = pgEnum("memberstatus", ["ACTIVE", "LEFT"]);

export const sessionstatus = pgEnum("sessionstatus", ["FULL", "NOTFULL"]);
